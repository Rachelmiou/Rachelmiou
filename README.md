...
an interactive calculator that tells you whether hopping on ontario's 407 ETR is actually worth the toll. compares toll cost, fuel savings, and time saved to give a clear take-it-or-skip-it verdict. built with React + Vite, featuring real rate zones, time-of-day pricing, and a cheapest short hop finder.
...
*currently looking for my next co-op, let's talk* ✨
